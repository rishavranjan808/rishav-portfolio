...
import profilePic from "./profile.png"; // Make sure this file exists in /src
...
export default function App() {
  ...
  const projects = [
    {
      title: "Airplane Revenue Analysis",
      link: "#",
      description:
        "SQL, Python and Power BI analysis of seat occupancy, booking trends and revenue opportunities.",
    },
    {
      title: "Customer Data Analysis for Personal Loan Conversion",
      link: "#",
      description:
        "Customer analytics and classification modelling using SQL, Python and Power BI to support targeting strategies.",
    },
  ];
...
<p className="text-gray-600 leading-relaxed">
  ...
  informed decisions.
      ...
      <section id="education" className="scroll-mt-32 py-20 bg-white">
      ...
      <section id="projects" className="scroll-mt-32 py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-center mb-12">
            Projects
          </h2>
